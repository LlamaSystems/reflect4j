package io.github.llamasystems.reflect4j.api.descriptor;

import io.github.llamasystems.reflect4j.api.exception.ClassNotFoundRuntimeException;
...
public interface ClassDescriptor<T> extends AnnotatedElementDescriptor<Class<T>, ClassDescriptor<T>> {
    ...
    /// @throws InvalidSignatureException if the signature is not a valid JVM-style method descriptor
    ...
    /// @throws NullPointerException                                        if the signature is `null`
    /// @throws InvalidSignatureException if the signature is not a valid JVM-style constructor descriptor
